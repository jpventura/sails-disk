...
Application.prototype.create = function(pathname, collection) {
  ...
  const createRecord = function(record) {
    ...
    const incrementCount = function(record) {
      ...
      return counts.child(record.id)
        .transaction(transactionUpdate)
        .then(resolve);
    };

    // const unserializeRecordFromDocument = function(document) {
    //   return self._unserialize(pathname, document);
    // };
